...
function feat = getmyfeat(x,winsize,wininc,datawin,dispstatus)
...
for i = 1:numwin
    ...
    % where Fine structure constant alpha = (q^2)/(h*c*4*pi*epsilonot) = (1/137.03599908)
    feat(i,:) = (1/137.03599908).^mean(abs(curwin));
